...
public class PlayerDAOTest {
    ...
    public void testAddPlayerDuplicateFideID() {
        ...
        Player player = new Player(14, "FIDE002", "Kỳ thủ mới", 2000, "VIE", 1500.0f, "Thêm mới trùng ID");
    ...
    public void testDeletePlayerSuccess() {
        ...
        try {
            ...
            boolean result = instance.deletePlayer(player);
            assertTrue("Mong đợi xóa thành công (có dòng bị xóa)", result);
    ...
    public void testEditPlayerDuplicateFideID() {
        ...
        Player player = new Player(3, "4168119", "Nguyen Van A", 1990, "VIE", 2500.0f, "Sửa bị lỗi do trùng Fide ID");
        PlayerDAO instance = new PlayerDAO();
